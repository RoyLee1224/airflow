 ...
 *
 * This component combines the functionality of HoverTooltip and ManualTooltip into
 ...
 * ```
 */
export const ManualTooltipV2 = ({ children, config, content, delayMs = 500 }: Props): ReactElement => {
