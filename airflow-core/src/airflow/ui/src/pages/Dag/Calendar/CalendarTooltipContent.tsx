...
/**
 * Content component for calendar cell tooltips
 * Displays run counts by state for a specific date
 */
export const CalendarTooltipContent = ({ cellData, viewMode = "total" }: Props) => {
